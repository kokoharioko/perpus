...
if(isset($_POST["cari"]))
{
	$hasil = caritabel2($_POST["keyword"]);
}
?>
<html>
...
<div id = "mypages">
	...
	<div id ="content">
	<form action="pengarang.php" method="post">
	<input type="text" id="cari" name="keyword"  autofocus=""placeholder="Silahkan input pencarian">
    <button type="submit" name="cari">Cari</button>
	</form>
	<a href="tambahpengarang.php">TAMBAH DATA</a>
	<div id = "kontenatas"> TABEL DATA PENGARANG<br>
	<table border="3" align="center"> 
					...
					<?php foreach($hasil as $row) : ?>
						<tr>
							...
							<td><a href="editpengarang.php?idprg=<?php echo $row['id_pengarang']; ?>&nmprg=<?php echo $row['nama_pengarang'];?>" >Edit</a></td>	
							<td><a href="proseshapuspengarang.php?idprg=<?php echo $row['id_pengarang']; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus</a> </td>
						</tr>
					<?php $i++;?>
					<?php endforeach;?>
	</table>
